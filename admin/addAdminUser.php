    ...
    <div class="<?=$screenwidth?>">
      ...
      <div class="form-group"  id="page-wrap" style="margin-left:10px;">
          ...
          <div class="form-group">
            <div class="col-md-6">
                <label class="col-md-5 control-label">User Name <span class="red_small">*</span></label>
                <div class="col-md-5">
...
<!--              mobiel num and email id-->
              <div class="form-group">
                  <div class="col-md-6">
                      <label class="col-md-5 control-label">
                          Mobile No. <span class="red_small">*</span>
                      </label>
                      <div class="col-md-5">
                  ...
                  <div class="col-md-6">
                      <label class="col-md-5 control-label">Email-Id <span class="red_small">*</span></label>
                      <div class="col-md-5">
