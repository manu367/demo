...
global $link1;
function getAllFMS($link1, $selectedValue = ''){
    $sql = "SELECT * FROM `fms_master`";
    ...
    $selectBox = "<select class='form-control' name='fms_name' onchange='this.form.submit()'>";
...
$fms_other_data=getFMsMaste_Data($link1,$date_wise_data);
$fms_other_data=prepareChartData($fms_other_data);
...
<div class="container-fluid">
    <div class="row content">
        ...
        <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
            <h2 align="center"><i class="fa fa-pencil-square-o"></i> FMS Analysis</h2>
            <div class="container-fluid" style="margin-top: 50px">
                    ...
                    <div class="col">
                        <form class="form-horizontal" role="form" name="form1"  id="form1" action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6"><label class="col-md-5 control-label">FMS</label>
                                    <div class="col-md-5" align="left">
                                       <?php
                                       $selectedFms = $_REQUEST['fms_name'] ?? '';
                                       echo getAllFMS($link1, $selectedFms);
                                       ?>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?=renderChart('AREA',
                            'FMS Category Chart',
                            'FMS/Other type of FMS','left','fms_other_chart')?>
                    </div>
                    <div class="col-md-6">
                        <div id="container_1">
                            ...
                            <?=renderChart('PIE',
                                    'FMS Active',
                                    'ACTIVE FMS CHART','left','active_inactive_chart')?>
                        </div>
                    </div>
                </div>
            </div>
