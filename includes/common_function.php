...
function getFullStatus($gettingfor,$link1){
    ...
    $query_1="select statusid, statusname from status_master where ".$used_in."";
	$result_set = mysqli_query($link1,$query_1) or die(mysqli_error($link1));
...
function getTabRights($uid,$link1){
    ...
    $tab_right="select tabid, status from access_tab where userid = '".$uid."'";
	$result_set = mysqli_query($link1,$tab_right) or die(mysqli_error($link1));
